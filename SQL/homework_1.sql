...
2. Вывести всех студентов в таблице - SELECT name, email, password FROM students;
...
14. Вывести пользователей которые были созданы 2021-07-12 00:00:00 и имеют пароль 1m313 - SELECT * FROM students WHERE created_on = 'C2021-07-12 00:00:00' AND password = '1m313';
...
26. Вывести пользователей где password равен 12333, 1m313, 123313 - SELECT * FROM students WHERE password = '12333' OR password = '123313' OR password = '1m313';
27. Вывести пользователей где created_on равен 2020-10-03 00:00:00, 2021-05-19 00:00:00, 2021-03-26 00:00:00 - SELECT * FROM students WHERE created_on = '2020-10-03 00:00:00' OR created_on = '2021-03-26 00:00:00';
